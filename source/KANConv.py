import torch
import math
from source.KANLayer import KANLinear
from source.convolution import multiple_convs_kan_conv2d, kan_conv2d
...
class KAN_Convolutional_Layer(torch.nn.Module):
    ...
    def forward(self, x: torch.Tensor, update_grid=False):
        ...
        if self.n_convs > 1:
            return multiple_convs_kan_conv2d(x, self.convs, self.kernel_size[0], self.stride, self.dilation,
